...
TOKEN = '8649901229:AAHeFhTHOVgpmWJm_IkVlzmbJddpuBxYulo'
OWNER_ID = int(os.getenv('OWNER_ID', 8474226561))
ADMIN_ID = int(os.getenv('ADMIN_ID', 6467928792))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', 'Fsociety_zodiac07')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'botscripts18')
